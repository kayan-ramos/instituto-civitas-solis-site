...
const runtime = `;(()=>{
  ...
  const publicationsBooks=[
    ...
    {title:"Cartas de Amor",subtitle:"Do Espírito para Ti",author:"Jacob Beilhart",meta:"eBook · Loja Civitas Solis",image:"/assets/home-books/cartas-de-amor.jpg",url:"https://loja.civitassolis.org.br/cartas-de-amor",button:"Comprar na Loja",description:"Um diálogo interior entre o Espírito e a Alma. Escrito por volta de 1900, o livro apresenta uma mensagem simples, direta e vivificante sobre amor, consciência e plenitude da vida."}
  ];
  const amazonButton=book=>'<a class="ics-amazon-button" href="'+book.url+'" target="_blank" rel="noopener noreferrer" aria-label="Comprar '+book.title+'"><span>'+(book.button||"Compre na Amazon")+'</span><span class="ics-amazon-mark" aria-hidden="true">a</span></a>';
