...
const outputName = "index-publications-hover-e7f4c2.js";
const cssOutputName = "index-publications-hover-e7f4c2.css";
const revision = "publications-hover-2026-09-14";
...
const runtime = `;(()=>{
  ...
  const apply=()=>{safe(fixValues);safe(fixMvvHero);safe(fixMissionVision);safe(ensureVideo);safe(ensureGlobal);safe(fixHomeYouTube);safe(fixYouTube)};
